        ...
        return (
            <>
                ...
                <Card style={{ width: '18rem' }} className="card">
                            ...
                            <Card.Body>
                                <Card.Title>{this.props.item.localized_name}</Card.Title>
                                <Card.Title>{this.props.item.attack_type}</Card.Title>
                                <Button onClick={e => { this.deleteFav(this.props.item.localized_name) }} variant="primary">Delete</Button>
